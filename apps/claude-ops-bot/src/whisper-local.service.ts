// TODO: dedupe with packages/api/src/services/whisper-local.service.ts once workspace package exposes it properly
 ...
 * ASYNC — does not block Node.js event loop, so other requests keep flowing.
 */
