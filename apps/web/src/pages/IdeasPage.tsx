    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        <div className="flex gap-4 overflow-x-auto">
          {CATEGORIES.map((cat) => (
            <div key={cat} className="w-72 min-w-[288px] bg-gray-100 rounded-xl p-3">
              ...
              <div className="flex flex-col gap-2">
                ...
                {(grouped[cat]?.length ?? 0) === 0 && <div className="text-gray-300 text-xs text-center py-4">No ideas</div>}
              </div>
            </div>
          ))}
        </div>
